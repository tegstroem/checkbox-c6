import { n as __export } from "./chunk-SL3VIQZ3-D8QYRKoW.js";
import { st as definePreviewAddon10 } from "./components-B-_VFReB.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-Cyl5zTsW.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-B0Ihwt-7.js");
