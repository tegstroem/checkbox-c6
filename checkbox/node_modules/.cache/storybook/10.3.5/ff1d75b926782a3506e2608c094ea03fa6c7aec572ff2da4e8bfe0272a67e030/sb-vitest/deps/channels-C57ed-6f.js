import { t as dedent } from "./chunk-3LY4VQVK-BqGwjJJ0.js";
import { a as scope } from "./client-logger-CbznJWWA.js";
import "./core-events-DDthIPYQ.js";
...
var memoizeCapped_default = memoizeCapped, rePropName = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, reEscapeChar = /\\(\\)?/g, stringToPath_default = memoizeCapped_default(function(string) {
	var result = [];
...
var castPath_default = castPath, INFINITY2 = Infinity;
...
//#endregion
//#region node_modules/storybook/dist/_browser-chunks/chunk-IWQGIXJS.js
var isProduction = false, prefix = "Invariant failed";
...
//#endregion
//#region node_modules/storybook/dist/channels/index.js
...
}, { document: document2, location } = scope, { WebSocket } = scope, { CHANNEL_OPTIONS, CONFIG_TYPE } = scope;
//#endregion
export { stringify as a, parse as i, invariant as n, UniversalStore as r, Channel as t };

//# sourceMappingURL=channels-C57ed-6f.js.map